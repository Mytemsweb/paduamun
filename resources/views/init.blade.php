...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-inner fixed-top custom-nav sticky">
        <div class="container">
            <!-- LOGO -->
            <a class="navbar-brand brand-logo mr-4" href="index1.html">
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarCollapse">
                <ul class="navbar-nav navbar-center" id="mySidenav">
                    ...
                    <li class="nav-item">
                        <a href="features.html" class="nav-link">Comittees</a>
                    </li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="content-fadeInUp">
                                    ...
                                    <h1 class="text-white font-20">Second Edition - April 26 and 27</h1>
                                    <p class="para-txt"></p>
                                    <div class="learn-more">
                                        <a href="#aboutus" class="btn btn-white btn-rounded text-white">Apply now!</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="img-fadeInRight">
                                    <img src="images/slider-img/02-padua-mun.png" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row mt-2">
                <div class="col-12 text-center">
                    <img src="data:image/svg+xml;charset=UTF-8,<svg xmlns='http://www.w3.org/2000/svg' width='1200' height='400' style='background:gray'><rect width='1200' height='400' fill='gray'/></svg>" class="img-fluid w-100 rounded mb-3" alt="Edith Quiñe">
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const navbar = document.querySelector(".navbar"); // Asegúrate de que este selector coincide con tu navbar
